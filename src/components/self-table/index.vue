    ...
    >
      ...
      <template v-if="columns.length > 0">   
        ...
        <template v-for="({ header, slot, ...item }, index) in columns">
          ...
          <el-table-column v-if="!item.hidden" v-bind="{ ...item }" :key="index" :prop="item.prop" :label="item.label">
            ...
            <template slot-scope="scope">
              ...
              <div v-else>
                ...
                <el-popover
                  ...
                  :disabled="!(Object.prototype.toString.call(item.showPop) === '[object Boolean]' && item.showPop)"
                >
                  <!-- 仅展示文本 -->
